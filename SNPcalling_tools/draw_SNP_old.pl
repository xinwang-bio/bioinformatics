...
( defined $opts{'lis_chrLen'} and defined $opts{'lis_windR'} ) or die "perl $0 -lis_chrLen ITAG2.3_genomic.fa.kl   -lis_windR CheesRIL_p204_LA483_diffHomo_wi35offs.tab.indv_cntR   -out_svg out.svg\n"; 
