...
my $ir_return_plus = &AS_event_IR(\%plus_doner, \%plus_acceptor, $sort_bam, $strand, $min_maq);
...
my $ir_return_minus = &AS_event_IR(\%minus_doner, \%minus_acceptor, $sort_bam, $strand, $min_maq);
